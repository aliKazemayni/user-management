...
<html lang="en" data-bs-theme="auto">
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4" style="height: 95vh">
    ...
    <script src="/scripts/bootstrap.bundle.min.js" class="astro-vvvwv3sm"></script>
    <script src="/scripts/dashboard.js" class="astro-vvvwv3sm"></script>
    </body>
</html>