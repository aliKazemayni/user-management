...
class Log
{
    ...
    {
        self::pre($value,'print_r',$isDie, self::$errorStyle);
    }
    ...
    private static function pre(mixed $value, string $method, bool $isDie, string $style = null): void
    {
        $finalStyle = $style ?? self::$style;
